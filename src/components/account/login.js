...
function Login({isUserAuthenticated}) {
  ...
  return (
    ...
    <Component>
      ...
      <TextField id="standard-basic" type='password' onChange={(e)=> onvaluechange(e)} label="Password" variant="standard" name="password" value={login.password}/>
    ...
    :
        ...
        <TextField id="standard-basic" type='password' onChange={(e)=>onInputChange(e)} label="Password" variant="standard" name="password" value={signup.password} />
        {/* {error && <Error>{error}</Error>} */}
